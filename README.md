...
| • parse · small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  8.92 µs/iter` | `  7.36 µs` | `  8.98 µs` | ` 10.09 µs` | ` 13.40 µs` |
| lightning-yaml | ` 19.01 µs/iter` | ` 18.43 µs` | ` 19.09 µs` | ` 19.65 µs` | ` 19.87 µs` |

| • parse · medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `790.27 µs/iter` | `641.50 µs` | `818.17 µs` | `  1.47 ms` | `  1.87 ms` |
| lightning-yaml | `  1.74 ms/iter` | `  1.58 ms` | `  1.72 ms` | `  2.80 ms` | `  2.88 ms` |

| • parse · large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  8.58 ms/iter` | `  7.77 ms` | `  8.93 ms` | ` 10.85 ms` | ` 11.01 ms` |
| lightning-yaml | ` 20.69 ms/iter` | ` 18.57 ms` | ` 22.62 ms` | ` 22.96 ms` | ` 23.17 ms` |

| • parse · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `100.15 ms/iter` | ` 91.43 ms` | ` 99.59 ms` | `107.15 ms` | `129.45 ms` |
| lightning-yaml | `208.70 ms/iter` | `197.35 ms` | `209.90 ms` | `217.13 ms` | `249.92 ms` |

| • parse · medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  1.50 ms/iter` | `  1.36 ms` | `  1.50 ms` | `  2.34 ms` | `  2.61 ms` |
| lightning-yaml | `  3.02 ms/iter` | `  2.86 ms` | `  3.06 ms` | `  4.06 ms` | `  4.20 ms` |

| • parse · large-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 10.77 ms/iter` | ` 10.09 ms` | ` 10.77 ms` | ` 13.50 ms` | ` 13.51 ms` |
| lightning-yaml | ` 22.95 ms/iter` | ` 21.17 ms` | ` 24.25 ms` | ` 26.71 ms` | ` 26.87 ms` |

| • parse · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 21.08 µs/iter` | ` 20.25 µs` | ` 21.13 µs` | ` 22.01 µs` | ` 23.28 µs` |

| • parse · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  2.59 ms/iter` | `  2.40 ms` | `  2.58 ms` | `  3.71 ms` | `  3.91 ms` |

| • parse · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 26.98 ms/iter` | ` 25.15 ms` | ` 27.73 ms` | ` 29.66 ms` | ` 31.95 ms` |

| • parse · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  1.29 ms/iter` | `  1.20 ms` | `  1.30 ms` | `  1.69 ms` | `  2.16 ms` |

| • parse · yaml-rich-small |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 29.38 µs/iter` | ` 28.69 µs` | ` 29.25 µs` | ` 29.39 µs` | ` 32.39 µs` |

| • parse · yaml-rich-medium |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  2.24 ms/iter` | `  2.06 ms` | `  2.16 ms` | `  3.92 ms` | `  4.04 ms` |

| • parse · yaml-rich-large |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 21.18 ms/iter` | ` 20.17 ms` | ` 22.10 ms` | ` 23.03 ms` | ` 23.14 ms` |

### Speed — stringify (mitata, sequential)

| • stringify · small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  4.56 µs/iter` | `  4.39 µs` | `  4.61 µs` | `  4.73 µs` | `  4.73 µs` |
| lightning-yaml | ` 23.25 µs/iter` | ` 22.97 µs` | ` 23.25 µs` | ` 23.69 µs` | ` 23.84 µs` |

| • stringify · medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `486.48 µs/iter` | `450.49 µs` | `494.51 µs` | `728.75 µs` | `950.17 µs` |
| lightning-yaml | `  4.66 ms/iter` | `  3.65 ms` | `  5.52 ms` | `  7.90 ms` | `  8.71 ms` |

| • stringify · large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  6.88 ms/iter` | `  6.16 ms` | `  6.70 ms` | ` 11.98 ms` | ` 12.06 ms` |
| lightning-yaml | ` 59.89 ms/iter` | ` 53.97 ms` | ` 59.60 ms` | ` 60.46 ms` | ` 81.08 ms` |

| • stringify · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 62.49 ms/iter` | ` 59.30 ms` | ` 61.80 ms` | ` 69.10 ms` | ` 72.88 ms` |
| lightning-yaml | `681.37 ms/iter` | `572.31 ms` | `614.08 ms` | `926.56 ms` | `   1.37 s` |

| • stringify · medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  1.06 ms/iter` | `939.78 µs` | `  1.06 ms` | `  1.67 ms` | `  3.92 ms` |
| lightning-yaml | `  5.71 ms/iter` | `  5.16 ms` | `  5.69 ms` | `  7.72 ms` | `  8.31 ms` |

| • stringify · large-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  7.93 ms/iter` | `  7.32 ms` | `  8.17 ms` | `  9.45 ms` | `  9.58 ms` |
| lightning-yaml | ` 50.64 ms/iter` | ` 48.29 ms` | ` 50.56 ms` | ` 52.07 ms` | ` 53.43 ms` |

| • stringify · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  3.54 µs/iter` | `  3.44 µs` | `  3.59 µs` | `  3.75 µs` | `  3.78 µs` |
| lightning-yaml | ` 18.92 µs/iter` | ` 18.70 µs` | ` 18.88 µs` | ` 19.14 µs` | ` 19.51 µs` |

| • stringify · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `461.72 µs/iter` | `420.24 µs` | `470.98 µs` | `625.30 µs` | `  1.01 ms` |
| lightning-yaml | `  3.44 ms/iter` | `  3.02 ms` | `  3.26 ms` | `  5.45 ms` | `  5.67 ms` |

| • stringify · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  5.19 ms/iter` | `  4.92 ms` | `  5.24 ms` | `  6.01 ms` | `  7.36 ms` |
| lightning-yaml | ` 46.25 ms/iter` | ` 43.95 ms` | ` 47.17 ms` | ` 47.51 ms` | ` 47.72 ms` |

| • stringify · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `223.76 µs/iter` | `205.36 µs` | `229.72 µs` | `357.45 µs` | `702.70 µs` |
| lightning-yaml | `  1.09 ms/iter` | `975.91 µs` | `  1.08 ms` | `  2.03 ms` | `  2.12 ms` |

| • stringify · yaml-rich-small |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 27.98 µs/iter` | ` 27.64 µs` | ` 28.03 µs` | ` 28.22 µs` | ` 28.62 µs` |

| • stringify · yaml-rich-medium |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  2.69 ms/iter` | `  2.42 ms` | `  2.66 ms` | `  3.70 ms` | `  3.76 ms` |

| • stringify · yaml-rich-large |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 36.72 ms/iter` | ` 34.35 ms` | ` 37.23 ms` | ` 39.87 ms` | ` 40.44 ms` |
...
| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.33 MB | 1.00x | -2.96 KB | 1.00x |
| lightning-yaml | 91.98 MB | 0.96x | 86.89 KB | -29.35x |

**stringify · small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 91.59 MB | 1.00x | -5.15 KB | 1.00x |
| lightning-yaml | 95.11 MB | 1.04x | 30.95 KB | -6.01x |

**parse · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 94.12 MB | 1.00x | 174.23 KB | 1.00x |
| lightning-yaml | 96.75 MB | 1.03x | 455.52 KB | 2.61x |

**stringify · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 96.34 MB | 1.00x | 98.72 KB | 1.00x |
| lightning-yaml | 112.80 MB | 1.17x | 209.00 KB | 2.12x |

**parse · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 118.63 MB | 1.00x | 1.95 MB | 1.00x |
| lightning-yaml | 132.80 MB | 1.12x | 3.26 MB | 1.67x |

**stringify · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 111.10 MB | 1.00x | 1.14 MB | 1.00x |
| lightning-yaml | 197.98 MB | 1.78x | 1.32 MB | 1.17x |

**parse · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 283.89 MB | 1.00x | 17.43 MB | 1.00x |
| lightning-yaml | 365.00 MB | 1.29x | 27.79 MB | 1.59x |

**stringify · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 297.54 MB | 1.00x | 10.23 MB | 1.00x |
| lightning-yaml | 631.94 MB | 2.12x | 9.99 MB | 0.98x |

**parse · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 93.68 MB | 1.00x | 228.83 KB | 1.00x |
| lightning-yaml | 96.86 MB | 1.03x | 422.45 KB | 1.85x |

**stringify · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 97.69 MB | 1.00x | 162.48 KB | 1.00x |
| lightning-yaml | 116.44 MB | 1.19x | 351.44 KB | 2.16x |

**parse · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 117.15 MB | 1.00x | 1.63 MB | 1.00x |
| lightning-yaml | 132.82 MB | 1.13x | 2.00 MB | 1.23x |

**stringify · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 111.21 MB | 1.00x | 1.19 MB | 1.00x |
| lightning-yaml | 189.65 MB | 1.71x | 1.91 MB | 1.60x |

**parse · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 95.39 MB | — | 107.08 KB | — |

**stringify · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 92.26 MB | 1.00x | -10.94 KB | 1.00x |
| lightning-yaml | 95.58 MB | 1.04x | 23.43 KB | -2.14x |

**parse · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 99.02 MB | — | 533.34 KB | — |

**stringify · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 112.67 MB | 1.00x | 80.55 KB | 1.00x |
| lightning-yaml | 137.50 MB | 1.22x | 179.37 KB | 2.23x |

**parse · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 134.60 MB | — | 2.78 MB | — |

**stringify · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 211.23 MB | 1.00x | 939.73 KB | 1.00x |
| lightning-yaml | 282.19 MB | 1.34x | 1.08 MB | 1.18x |

**parse · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 94.04 MB | — | 293.34 KB | — |

**stringify · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 110.11 MB | 1.00x | 29.80 KB | 1.00x |
| lightning-yaml | 107.21 MB | 0.97x | 153.93 KB | 5.16x |

**parse · yaml-rich-small**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 87.96 MB | — | 166.02 KB | — |

**stringify · yaml-rich-small**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 92.48 MB | — | 28.81 KB | — |

**parse · yaml-rich-medium**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 93.65 MB | — | 626.15 KB | — |

**stringify · yaml-rich-medium**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 114.84 MB | — | 228.77 KB | — |

**parse · yaml-rich-large**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 128.34 MB | — | 2.34 MB | — |

**stringify · yaml-rich-large**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 229.88 MB | — | 905.35 KB | — |
<!-- BENCH:OURS:END -->
