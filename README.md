...
| • parse · small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  4.91 µs/iter` | `  4.72 µs` | `  4.94 µs` | `  5.08 µs` | `  6.03 µs` |
| lightning-yaml | ` 10.70 µs/iter` | ` 10.49 µs` | ` 10.80 µs` | ` 10.82 µs` | ` 10.84 µs` |

| • parse · medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `559.47 µs/iter` | `497.75 µs` | `563.63 µs` | `  1.02 ms` | `  1.37 ms` |
| lightning-yaml | `  1.08 ms/iter` | `996.72 µs` | `  1.07 ms` | `  1.85 ms` | `  1.97 ms` |

| • parse · large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  7.02 ms/iter` | `  6.17 ms` | `  7.30 ms` | ` 10.40 ms` | ` 10.69 ms` |
| lightning-yaml | ` 13.18 ms/iter` | ` 11.66 ms` | ` 14.28 ms` | ` 15.04 ms` | ` 15.30 ms` |

| • parse · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 75.28 ms/iter` | ` 70.90 ms` | ` 74.07 ms` | ` 77.47 ms` | ` 94.77 ms` |
| lightning-yaml | `136.06 ms/iter` | `128.47 ms` | `138.01 ms` | `142.09 ms` | `156.19 ms` |

| • parse · medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  1.15 ms/iter` | `  1.04 ms` | `  1.15 ms` | `  1.82 ms` | `  2.04 ms` |
| lightning-yaml | `  1.98 ms/iter` | `  1.86 ms` | `  1.99 ms` | `  2.75 ms` | `  3.13 ms` |

| • parse · large-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  8.84 ms/iter` | `  7.74 ms` | `  9.70 ms` | ` 12.35 ms` | ` 12.53 ms` |
| lightning-yaml | ` 15.73 ms/iter` | ` 13.98 ms` | ` 16.39 ms` | ` 19.05 ms` | ` 23.70 ms` |

| • parse · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 13.34 µs/iter` | ` 12.89 µs` | ` 13.55 µs` | ` 13.70 µs` | ` 13.80 µs` |

| • parse · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  1.58 ms/iter` | `  1.47 ms` | `  1.58 ms` | `  2.43 ms` | `  2.50 ms` |

| • parse · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 16.29 ms/iter` | ` 15.33 ms` | ` 16.99 ms` | ` 17.93 ms` | ` 18.17 ms` |

| • parse · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `774.55 µs/iter` | `718.62 µs` | `779.16 µs` | `  1.04 ms` | `  1.47 ms` |

### Speed — stringify (mitata, sequential)

| • stringify · small-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  3.33 µs/iter` | `  3.21 µs` | `  3.39 µs` | `  3.61 µs` | `  3.72 µs` |

| • stringify · medium-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `424.09 µs/iter` | `350.11 µs` | `432.41 µs` | `719.55 µs` | `910.37 µs` |

| • stringify · large-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  5.45 ms/iter` | `  4.93 ms` | `  5.44 ms` | `  8.40 ms` | `  8.47 ms` |

| • stringify · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | ` 49.15 ms/iter` | ` 48.25 ms` | ` 49.72 ms` | ` 50.11 ms` | ` 50.26 ms` |

| • stringify · medium-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `878.12 µs/iter` | `780.43 µs` | `857.08 µs` | `  1.18 ms` | `  5.00 ms` |

| • stringify · large-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  6.48 ms/iter` | `  6.10 ms` | `  6.38 ms` | `  9.21 ms` | `  9.30 ms` |

| • stringify · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  2.74 µs/iter` | `  2.62 µs` | `  2.79 µs` | `  3.01 µs` | `  3.11 µs` |

| • stringify · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `383.77 µs/iter` | `336.78 µs` | `395.00 µs` | `615.07 µs` | `878.56 µs` |

| • stringify · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  4.52 ms/iter` | `  4.10 ms` | `  4.43 ms` | `  7.50 ms` | `  7.64 ms` |

| • stringify · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `184.54 µs/iter` | `158.40 µs` | `188.16 µs` | `287.26 µs` | `660.61 µs` |
...
| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 91.61 MB | 1.00x | -3.58 KB | 1.00x |
| lightning-yaml | 93.00 MB | 1.02x | 56.63 KB | -15.83x |

**stringify · small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 92.61 MB | 1.00x | -6.65 KB | 1.00x |

**parse · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 92.72 MB | 1.00x | 172.08 KB | 1.00x |
| lightning-yaml | 93.27 MB | 1.01x | 417.84 KB | 2.43x |

**stringify · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 90.53 MB | 1.00x | 96.38 KB | 1.00x |

**parse · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 119.13 MB | 1.00x | 1.95 MB | 1.00x |
| lightning-yaml | 132.75 MB | 1.11x | 3.21 MB | 1.65x |

**stringify · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 109.23 MB | 1.00x | 1.13 MB | 1.00x |

**parse · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 282.32 MB | 1.00x | 17.43 MB | 1.00x |
| lightning-yaml | 365.20 MB | 1.29x | 27.74 MB | 1.59x |

**stringify · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 288.00 MB | 1.00x | 10.23 MB | 1.00x |

**parse · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 91.50 MB | 1.00x | 227.72 KB | 1.00x |
| lightning-yaml | 93.13 MB | 1.02x | 389.91 KB | 1.71x |

**stringify · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 96.61 MB | 1.00x | 162.02 KB | 1.00x |

**parse · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 114.12 MB | 1.00x | 1.63 MB | 1.00x |
| lightning-yaml | 131.07 MB | 1.15x | 1.96 MB | 1.20x |

**stringify · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 108.07 MB | 1.00x | 1.19 MB | 1.00x |

**parse · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 92.67 MB | — | 55.99 KB | — |

**stringify · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 93.11 MB | 1.00x | -9.55 KB | 1.00x |

**parse · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 93.13 MB | — | 463.84 KB | — |

**stringify · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 112.39 MB | 1.00x | 88.88 KB | 1.00x |

**parse · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 130.60 MB | — | 2.71 MB | — |

**stringify · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 211.65 MB | 1.00x | 939.70 KB | 1.00x |

**parse · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 95.48 MB | — | 244.82 KB | — |

**stringify · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 100.91 MB | 1.00x | 31.88 KB | 1.00x |
<!-- BENCH:OURS:END -->
