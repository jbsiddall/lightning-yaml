...
| • parse · small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  5.08 µs/iter` | `  4.80 µs` | `  5.21 µs` | `  5.54 µs` | `  5.95 µs` |
| lightning-yaml | `  9.54 µs/iter` | `  9.29 µs` | `  9.58 µs` | `  9.83 µs` | `  9.95 µs` |

| • parse · medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `592.83 µs/iter` | `505.57 µs` | `593.41 µs` | `991.86 µs` | `  1.43 ms` |
| lightning-yaml | `978.48 µs/iter` | `857.99 µs` | `973.70 µs` | `  1.78 ms` | `  2.09 ms` |

| • parse · large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  6.83 ms/iter` | `  6.14 ms` | `  6.83 ms` | ` 10.62 ms` | ` 10.77 ms` |
| lightning-yaml | ` 11.52 ms/iter` | ` 10.05 ms` | ` 12.51 ms` | ` 13.35 ms` | ` 13.50 ms` |

| • parse · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 81.57 ms/iter` | ` 70.06 ms` | ` 77.80 ms` | `103.61 ms` | `137.16 ms` |
| lightning-yaml | `119.21 ms/iter` | `109.37 ms` | `118.35 ms` | `126.05 ms` | `151.35 ms` |

| • parse · medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  1.08 ms/iter` | `  1.02 ms` | `  1.08 ms` | `  1.85 ms` | `  2.12 ms` |
| lightning-yaml | `  1.80 ms/iter` | `  1.62 ms` | `  1.88 ms` | `  2.67 ms` | `  3.01 ms` |

| • parse · large-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 11.83 ms/iter` | ` 10.76 ms` | ` 11.94 ms` | ` 14.51 ms` | ` 15.21 ms` |
| lightning-yaml | ` 13.06 ms/iter` | ` 11.97 ms` | ` 13.94 ms` | ` 14.86 ms` | ` 15.02 ms` |

### Speed — stringify (mitata, sequential)

| • stringify · small-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  3.25 µs/iter` | `  3.20 µs` | `  3.30 µs` | `  3.35 µs` | `  3.36 µs` |

| • stringify · medium-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `380.86 µs/iter` | `353.76 µs` | `386.20 µs` | `497.83 µs` | `844.38 µs` |

| • stringify · large-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  5.19 ms/iter` | `  4.92 ms` | `  5.05 ms` | `  8.09 ms` | `  8.11 ms` |

| • stringify · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | ` 49.26 ms/iter` | ` 47.31 ms` | ` 48.38 ms` | ` 50.30 ms` | ` 59.16 ms` |

| • stringify · medium-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `855.26 µs/iter` | `774.27 µs` | `836.92 µs` | `  1.08 ms` | `  4.93 ms` |

| • stringify · large-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  6.37 ms/iter` | `  6.08 ms` | `  6.26 ms` | `  9.22 ms` | `  9.24 ms` |

| • stringify · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  2.73 µs/iter` | `  2.61 µs` | `  2.76 µs` | `  3.07 µs` | `  3.11 µs` |

| • stringify · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `376.80 µs/iter` | `336.26 µs` | `383.82 µs` | `620.10 µs` | `892.94 µs` |

| • stringify · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  4.51 ms/iter` | `  4.07 ms` | `  4.42 ms` | `  7.53 ms` | `  7.58 ms` |

| • stringify · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `171.83 µs/iter` | `159.07 µs` | `174.77 µs` | `218.81 µs` | `633.82 µs` |
...
| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 91.67 MB | 1.00x | -3.56 KB | 1.00x |
| lightning-yaml | 92.25 MB | 1.01x | 21.61 KB | -6.07x |

**stringify · small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 93.32 MB | 1.00x | -4.91 KB | 1.00x |

**parse · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.24 MB | 1.00x | 172.57 KB | 1.00x |
| lightning-yaml | 89.16 MB | 0.94x | 356.29 KB | 2.06x |

**stringify · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 90.20 MB | 1.00x | 96.90 KB | 1.00x |

**parse · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 122.57 MB | 1.00x | 1.95 MB | 1.00x |
| lightning-yaml | 129.11 MB | 1.05x | 3.16 MB | 1.62x |

**stringify · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 109.10 MB | 1.00x | 1.13 MB | 1.00x |

**parse · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 281.10 MB | 1.00x | 17.43 MB | 1.00x |
| lightning-yaml | 366.09 MB | 1.30x | 27.68 MB | 1.59x |

**stringify · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 288.27 MB | 1.00x | 10.23 MB | 1.00x |

**parse · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 91.20 MB | 1.00x | 226.56 KB | 1.00x |
| lightning-yaml | 97.54 MB | 1.07x | 332.51 KB | 1.47x |

**stringify · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 91.74 MB | 1.00x | 161.39 KB | 1.00x |

**parse · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 110.82 MB | 1.00x | 1.63 MB | 1.00x |
| lightning-yaml | 129.25 MB | 1.17x | 1.90 MB | 1.17x |

**stringify · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 108.20 MB | 1.00x | 1.19 MB | 1.00x |

**stringify · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 93.17 MB | 1.00x | -8.64 KB | 1.00x |

**stringify · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 114.82 MB | 1.00x | 81.80 KB | 1.00x |

**stringify · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 212.88 MB | 1.00x | 939.70 KB | 1.00x |

**stringify · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 100.05 MB | 1.00x | 31.88 KB | 1.00x |
<!-- BENCH:OURS:END -->
