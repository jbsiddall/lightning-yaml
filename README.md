...
| • parse · small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  4.89 µs/iter` | `  4.77 µs` | `  4.94 µs` | `  5.12 µs` | `  5.12 µs` |
| lightning-yaml | ` 10.84 µs/iter` | ` 10.67 µs` | ` 10.85 µs` | ` 10.99 µs` | ` 11.01 µs` |

| • parse · medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `602.74 µs/iter` | `512.60 µs` | `596.37 µs` | `  1.09 ms` | `  1.40 ms` |
| lightning-yaml | `  1.11 ms/iter` | `  1.01 ms` | `  1.12 ms` | `  1.89 ms` | `  2.08 ms` |

| • parse · large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  6.71 ms/iter` | `  6.24 ms` | `  6.60 ms` | `  8.48 ms` | `  8.59 ms` |
| lightning-yaml | ` 13.67 ms/iter` | ` 11.98 ms` | ` 14.72 ms` | ` 15.87 ms` | ` 16.00 ms` |

| • parse · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 80.48 ms/iter` | ` 75.97 ms` | ` 80.29 ms` | ` 81.52 ms` | ` 97.05 ms` |
| lightning-yaml | `145.82 ms/iter` | `136.00 ms` | `145.47 ms` | `160.63 ms` | `178.44 ms` |

| • parse · medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  1.19 ms/iter` | `  1.04 ms` | `  1.22 ms` | `  1.97 ms` | `  2.53 ms` |
| lightning-yaml | `  2.16 ms/iter` | `  1.91 ms` | `  2.20 ms` | `  3.36 ms` | `  4.02 ms` |

| • parse · large-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  8.83 ms/iter` | `  7.95 ms` | `  8.93 ms` | ` 11.24 ms` | ` 11.56 ms` |
| lightning-yaml | ` 15.90 ms/iter` | ` 14.46 ms` | ` 16.73 ms` | ` 18.62 ms` | ` 18.68 ms` |

### Speed — stringify (mitata, sequential)

| • stringify · small-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  3.22 µs/iter` | `  3.12 µs` | `  3.28 µs` | `  3.41 µs` | `  3.42 µs` |

| • stringify · medium-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `379.58 µs/iter` | `343.12 µs` | `388.78 µs` | `486.78 µs` | `867.23 µs` |

| • stringify · large-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  5.14 ms/iter` | `  4.80 ms` | `  5.00 ms` | `  8.02 ms` | `  8.23 ms` |

| • stringify · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | ` 47.95 ms/iter` | ` 47.12 ms` | ` 48.14 ms` | ` 49.20 ms` | ` 49.40 ms` |

| • stringify · medium-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `872.00 µs/iter` | `780.32 µs` | `861.70 µs` | `  1.17 ms` | `  5.11 ms` |

| • stringify · large-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  6.52 ms/iter` | `  6.07 ms` | `  6.46 ms` | `  9.48 ms` | `  9.67 ms` |

| • stringify · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  2.65 µs/iter` | `  2.52 µs` | `  2.69 µs` | `  2.96 µs` | `  2.96 µs` |

| • stringify · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `356.30 µs/iter` | `326.92 µs` | `361.97 µs` | `468.82 µs` | `881.89 µs` |

| • stringify · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  4.38 ms/iter` | `  4.01 ms` | `  4.25 ms` | `  7.37 ms` | `  7.51 ms` |

| • stringify · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `180.18 µs/iter` | `158.72 µs` | `183.45 µs` | `271.25 µs` | `618.24 µs` |
...
| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 93.04 MB | 1.00x | -4.68 KB | 1.00x |
| lightning-yaml | 92.17 MB | 0.99x | 44.64 KB | -9.54x |

**stringify · small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 88.52 MB | 1.00x | -7.30 KB | 1.00x |

**parse · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.02 MB | 1.00x | 172.08 KB | 1.00x |
| lightning-yaml | 97.20 MB | 1.02x | 402.23 KB | 2.34x |

**stringify · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 93.79 MB | 1.00x | 97.40 KB | 1.00x |

**parse · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 118.87 MB | 1.00x | 1.95 MB | 1.00x |
| lightning-yaml | 132.18 MB | 1.11x | 3.20 MB | 1.64x |

**stringify · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 104.83 MB | 1.00x | 1.14 MB | 1.00x |

**parse · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 281.75 MB | 1.00x | 17.43 MB | 1.00x |
| lightning-yaml | 366.38 MB | 1.30x | 27.72 MB | 1.59x |

**stringify · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 285.29 MB | 1.00x | 10.23 MB | 1.00x |

**parse · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 94.73 MB | 1.00x | 227.66 KB | 1.00x |
| lightning-yaml | 93.53 MB | 0.99x | 363.97 KB | 1.60x |

**stringify · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 96.77 MB | 1.00x | 163.07 KB | 1.00x |

**parse · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 114.07 MB | 1.00x | 1.63 MB | 1.00x |
| lightning-yaml | 128.28 MB | 1.12x | 1.94 MB | 1.19x |

**stringify · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 104.41 MB | 1.00x | 1.19 MB | 1.00x |

**stringify · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 89.22 MB | 1.00x | -9.55 KB | 1.00x |

**stringify · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 114.09 MB | 1.00x | 81.80 KB | 1.00x |
...
| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 105.01 MB | 1.00x | 31.88 KB | 1.00x |
<!-- BENCH:OURS:END -->
