...
| • parse · small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  6.42 µs/iter` | `  6.32 µs` | `  6.46 µs` | `  6.54 µs` | `  6.54 µs` |
| lightning-yaml | ` 16.57 µs/iter` | ` 16.09 µs` | ` 16.49 µs` | ` 16.82 µs` | ` 18.50 µs` |

| • parse · medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `696.94 µs/iter` | `641.83 µs` | `701.56 µs` | `930.15 µs` | `  1.57 ms` |
| lightning-yaml | `  1.62 ms/iter` | `  1.51 ms` | `  1.62 ms` | `  2.56 ms` | `  2.75 ms` |

| • parse · large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  8.40 ms/iter` | `  7.77 ms` | `  8.39 ms` | ` 10.63 ms` | ` 10.74 ms` |
| lightning-yaml | ` 20.33 ms/iter` | ` 17.59 ms` | ` 21.42 ms` | ` 23.85 ms` | ` 27.98 ms` |

| • parse · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 92.57 ms/iter` | ` 86.43 ms` | ` 93.33 ms` | ` 93.83 ms` | `112.63 ms` |
| lightning-yaml | `197.85 ms/iter` | `188.89 ms` | `197.75 ms` | `205.50 ms` | `232.77 ms` |

| • parse · medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  1.42 ms/iter` | `  1.35 ms` | `  1.42 ms` | `  2.31 ms` | `  2.44 ms` |
| lightning-yaml | `  2.92 ms/iter` | `  2.82 ms` | `  2.91 ms` | `  3.70 ms` | `  3.94 ms` |

| • parse · large-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 10.39 ms/iter` | `  9.94 ms` | ` 10.21 ms` | ` 12.44 ms` | ` 12.47 ms` |
| lightning-yaml | ` 22.36 ms/iter` | ` 20.91 ms` | ` 23.27 ms` | ` 24.92 ms` | ` 25.10 ms` |

| • parse · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 20.58 µs/iter` | ` 20.21 µs` | ` 20.59 µs` | ` 20.66 µs` | ` 22.08 µs` |

| • parse · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  2.50 ms/iter` | `  2.36 ms` | `  2.47 ms` | `  3.45 ms` | `  3.64 ms` |

| • parse · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 25.30 ms/iter` | ` 24.15 ms` | ` 26.38 ms` | ` 26.68 ms` | ` 26.93 ms` |

| • parse · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  1.22 ms/iter` | `  1.17 ms` | `  1.22 ms` | `  1.73 ms` | `  2.04 ms` |

| • parse · yaml-rich-small |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 28.61 µs/iter` | ` 28.26 µs` | ` 28.61 µs` | ` 29.01 µs` | ` 29.77 µs` |

| • parse · yaml-rich-medium |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  2.20 ms/iter` | `  2.06 ms` | `  2.16 ms` | `  3.24 ms` | `  3.42 ms` |

| • parse · yaml-rich-large |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 21.56 ms/iter` | ` 20.08 ms` | ` 22.42 ms` | ` 23.59 ms` | ` 23.60 ms` |

### Speed — stringify (mitata, sequential)

| • stringify · small-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  4.55 µs/iter` | `  4.37 µs` | `  4.59 µs` | `  4.95 µs` | `  5.05 µs` |

| • stringify · medium-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `509.39 µs/iter` | `457.30 µs` | `517.54 µs` | `841.35 µs` | `  1.06 ms` |

| • stringify · large-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  7.17 ms/iter` | `  6.18 ms` | `  6.93 ms` | ` 12.04 ms` | ` 12.39 ms` |

| • stringify · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | ` 63.64 ms/iter` | ` 62.05 ms` | ` 64.39 ms` | ` 64.55 ms` | ` 64.63 ms` |

| • stringify · medium-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `987.97 µs/iter` | `839.47 µs` | `962.84 µs` | `  1.48 ms` | `  7.73 ms` |

| • stringify · large-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  6.87 ms/iter` | `  6.28 ms` | `  6.68 ms` | ` 11.52 ms` | ` 11.60 ms` |

| • stringify · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  3.63 µs/iter` | `  3.52 µs` | `  3.66 µs` | `  3.76 µs` | `  3.78 µs` |

| • stringify · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `481.23 µs/iter` | `426.62 µs` | `491.96 µs` | `736.92 µs` | `  1.08 ms` |

| • stringify · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  5.41 ms/iter` | `  4.95 ms` | `  5.28 ms` | ` 10.52 ms` | ` 10.64 ms` |

| • stringify · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `214.62 µs/iter` | `188.72 µs` | `218.36 µs` | `336.06 µs` | `752.79 µs` |
...
| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 94.61 MB | 1.00x | -3.21 KB | 1.00x |
| lightning-yaml | 94.46 MB | 1.00x | 78.48 KB | -24.44x |

**stringify · small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 92.83 MB | 1.00x | -6.60 KB | 1.00x |

**parse · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 96.89 MB | 1.00x | 174.77 KB | 1.00x |
| lightning-yaml | 98.02 MB | 1.01x | 429.24 KB | 2.46x |

**stringify · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.30 MB | 1.00x | 97.97 KB | 1.00x |

**parse · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 124.76 MB | 1.00x | 1.95 MB | 1.00x |
| lightning-yaml | 133.07 MB | 1.07x | 3.23 MB | 1.66x |

**stringify · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 110.74 MB | 1.00x | 1.14 MB | 1.00x |

**parse · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 276.93 MB | 1.00x | 17.43 MB | 1.00x |
| lightning-yaml | 367.20 MB | 1.33x | 27.76 MB | 1.59x |

**stringify · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 300.06 MB | 1.00x | 10.23 MB | 1.00x |

**parse · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 96.92 MB | 1.00x | 227.32 KB | 1.00x |
| lightning-yaml | 99.31 MB | 1.02x | 389.72 KB | 1.71x |

**stringify · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 98.79 MB | 1.00x | 161.67 KB | 1.00x |

**parse · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 116.52 MB | 1.00x | 1.63 MB | 1.00x |
| lightning-yaml | 129.50 MB | 1.11x | 1.97 MB | 1.21x |

**stringify · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 105.34 MB | 1.00x | 1.19 MB | 1.00x |

**parse · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 91.18 MB | — | 93.10 KB | — |

**stringify · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.52 MB | 1.00x | -10.69 KB | 1.00x |

**parse · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 95.12 MB | — | 510.55 KB | — |

**stringify · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 116.79 MB | 1.00x | 87.94 KB | 1.00x |

**parse · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 130.41 MB | — | 2.76 MB | — |

**stringify · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 208.13 MB | 1.00x | 939.71 KB | 1.00x |

**parse · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 94.57 MB | — | 280.37 KB | — |

**stringify · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 108.00 MB | 1.00x | 29.29 KB | 1.00x |

**parse · yaml-rich-small**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 94.55 MB | — | 159.03 KB | — |

**parse · yaml-rich-medium**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 96.20 MB | — | 611.13 KB | — |

**parse · yaml-rich-large**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 129.67 MB | — | 2.32 MB | — |
<!-- BENCH:OURS:END -->
