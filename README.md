...
| • parse · small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  6.65 µs/iter` | `  6.41 µs` | `  6.73 µs` | `  6.89 µs` | `  6.94 µs` |
| lightning-yaml | ` 17.41 µs/iter` | ` 16.81 µs` | ` 17.31 µs` | ` 18.39 µs` | ` 18.88 µs` |

| • parse · medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `792.45 µs/iter` | `642.39 µs` | `823.59 µs` | `  1.21 ms` | `  1.75 ms` |
| lightning-yaml | `  1.71 ms/iter` | `  1.53 ms` | `  1.73 ms` | `  2.71 ms` | `  2.90 ms` |

| • parse · large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  9.21 ms/iter` | `  7.86 ms` | `  9.10 ms` | ` 14.35 ms` | ` 14.36 ms` |
| lightning-yaml | ` 21.55 ms/iter` | ` 18.90 ms` | ` 23.45 ms` | ` 24.68 ms` | ` 24.85 ms` |

| • parse · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `102.52 ms/iter` | ` 93.74 ms` | `103.12 ms` | `106.07 ms` | `133.75 ms` |
| lightning-yaml | `196.57 ms/iter` | `181.03 ms` | `202.43 ms` | `205.41 ms` | `228.27 ms` |

| • parse · medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  1.47 ms/iter` | `  1.33 ms` | `  1.43 ms` | `  2.34 ms` | `  2.54 ms` |
| lightning-yaml | `  2.93 ms/iter` | `  2.71 ms` | `  2.84 ms` | `  4.54 ms` | `  4.56 ms` |

| • parse · large-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 10.21 ms/iter` | `  9.79 ms` | ` 10.02 ms` | ` 12.49 ms` | ` 12.69 ms` |
| lightning-yaml | ` 20.87 ms/iter` | ` 20.09 ms` | ` 21.18 ms` | ` 23.14 ms` | ` 23.19 ms` |

| • parse · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 20.47 µs/iter` | ` 20.03 µs` | ` 20.45 µs` | ` 21.36 µs` | ` 21.83 µs` |

| • parse · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  2.46 ms/iter` | `  2.33 ms` | `  2.47 ms` | `  3.32 ms` | `  3.47 ms` |

| • parse · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 25.00 ms/iter` | ` 23.96 ms` | ` 25.72 ms` | ` 26.48 ms` | ` 27.23 ms` |

| • parse · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  1.23 ms/iter` | `  1.15 ms` | `  1.21 ms` | `  2.16 ms` | `  2.21 ms` |

| • parse · yaml-rich-small |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 24.33 µs/iter` | ` 23.84 µs` | ` 24.31 µs` | ` 25.11 µs` | ` 25.34 µs` |

| • parse · yaml-rich-medium |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  1.64 ms/iter` | `  1.57 ms` | `  1.65 ms` | `  2.29 ms` | `  2.53 ms` |

| • parse · yaml-rich-large |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 15.95 ms/iter` | ` 15.44 ms` | ` 16.07 ms` | ` 17.44 ms` | ` 17.45 ms` |

### Speed — stringify (mitata, sequential)

| • stringify · small-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  4.47 µs/iter` | `  4.34 µs` | `  4.50 µs` | `  4.74 µs` | `  4.80 µs` |

| • stringify · medium-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `495.26 µs/iter` | `450.52 µs` | `504.97 µs` | `700.79 µs` | `  1.04 ms` |

| • stringify · large-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  6.99 ms/iter` | `  6.19 ms` | `  6.86 ms` | ` 12.16 ms` | ` 12.21 ms` |

| • stringify · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | ` 67.01 ms/iter` | ` 62.41 ms` | ` 65.40 ms` | ` 68.01 ms` | ` 97.48 ms` |

| • stringify · medium-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `959.30 µs/iter` | `821.02 µs` | `921.78 µs` | `  1.37 ms` | `  7.50 ms` |

| • stringify · large-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  6.80 ms/iter` | `  6.28 ms` | `  6.57 ms` | ` 11.81 ms` | ` 11.92 ms` |

| • stringify · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  3.56 µs/iter` | `  3.45 µs` | `  3.60 µs` | `  3.75 µs` | `  3.93 µs` |

| • stringify · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `499.32 µs/iter` | `422.68 µs` | `502.55 µs` | `868.11 µs` | `  1.08 ms` |

| • stringify · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `  5.39 ms/iter` | `  4.89 ms` | `  5.29 ms` | ` 10.11 ms` | ` 10.16 ms` |

| • stringify · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| ---- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON | `203.70 µs/iter` | `187.31 µs` | `209.82 µs` | `286.95 µs` | `690.07 µs` |
...
| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 93.73 MB | 1.00x | -3.98 KB | 1.00x |
| lightning-yaml | 91.99 MB | 0.98x | 73.39 KB | -18.46x |

**stringify · small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 93.91 MB | 1.00x | -6.22 KB | 1.00x |

**parse · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 96.24 MB | 1.00x | 173.44 KB | 1.00x |
| lightning-yaml | 98.86 MB | 1.03x | 431.59 KB | 2.49x |

**stringify · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 94.95 MB | 1.00x | 96.65 KB | 1.00x |

**parse · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 120.34 MB | 1.00x | 1.95 MB | 1.00x |
| lightning-yaml | 133.34 MB | 1.11x | 3.23 MB | 1.65x |

**stringify · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 109.93 MB | 1.00x | 1.14 MB | 1.00x |

**parse · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 279.48 MB | 1.00x | 17.43 MB | 1.00x |
| lightning-yaml | 361.95 MB | 1.30x | 27.76 MB | 1.59x |

**stringify · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 296.24 MB | 1.00x | 10.23 MB | 1.00x |

**parse · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.03 MB | 1.00x | 228.24 KB | 1.00x |
| lightning-yaml | 95.40 MB | 1.00x | 382.69 KB | 1.68x |

**stringify · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.01 MB | 1.00x | 162.44 KB | 1.00x |

**parse · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 112.29 MB | 1.00x | 1.63 MB | 1.00x |
| lightning-yaml | 125.23 MB | 1.12x | 1.95 MB | 1.20x |

**stringify · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 109.70 MB | 1.00x | 1.19 MB | 1.00x |

**parse · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 94.15 MB | — | 87.28 KB | — |

**stringify · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 94.46 MB | 1.00x | -9.52 KB | 1.00x |

**parse · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 95.30 MB | — | 496.40 KB | — |

**stringify · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 111.52 MB | 1.00x | 89.95 KB | 1.00x |

**parse · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 129.61 MB | — | 2.75 MB | — |

**stringify · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 212.02 MB | 1.00x | 939.71 KB | 1.00x |

**parse · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 94.16 MB | — | 275.80 KB | — |

**stringify · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 103.07 MB | 1.00x | 32.29 KB | 1.00x |

**parse · yaml-rich-small**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 92.57 MB | — | 89.06 KB | — |

**parse · yaml-rich-medium**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 97.01 MB | — | 408.27 KB | — |

**parse · yaml-rich-large**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 125.46 MB | — | 1.59 MB | — |
<!-- BENCH:OURS:END -->
