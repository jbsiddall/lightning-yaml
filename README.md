...
| • parse · small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  6.34 µs/iter` | `  6.23 µs` | `  6.39 µs` | `  6.48 µs` | `  6.50 µs` |
| lightning-yaml | ` 15.96 µs/iter` | ` 15.79 µs` | ` 16.00 µs` | ` 16.06 µs` | ` 16.43 µs` |

| • parse · medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `713.12 µs/iter` | `644.52 µs` | `722.04 µs` | `  1.11 ms` | `  1.66 ms` |
| lightning-yaml | `  1.57 ms/iter` | `  1.45 ms` | `  1.56 ms` | `  2.44 ms` | `  2.59 ms` |

| • parse · large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  8.43 ms/iter` | `  7.73 ms` | `  8.35 ms` | ` 10.66 ms` | ` 10.72 ms` |
| lightning-yaml | ` 19.30 ms/iter` | ` 17.29 ms` | ` 21.08 ms` | ` 21.58 ms` | ` 21.77 ms` |

| • parse · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 94.69 ms/iter` | ` 88.17 ms` | ` 94.77 ms` | ` 98.66 ms` | `114.55 ms` |
| lightning-yaml | `202.92 ms/iter` | `176.40 ms` | `228.90 ms` | `233.91 ms` | `244.99 ms` |

| • parse · medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  1.52 ms/iter` | `  1.33 ms` | `  1.53 ms` | `  2.38 ms` | `  2.94 ms` |
| lightning-yaml | `  3.22 ms/iter` | `  2.82 ms` | `  3.16 ms` | `  5.09 ms` | `  5.15 ms` |

| • parse · large-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 10.78 ms/iter` | `  9.94 ms` | ` 11.00 ms` | ` 13.38 ms` | ` 13.78 ms` |
| lightning-yaml | ` 23.00 ms/iter` | ` 21.08 ms` | ` 23.80 ms` | ` 25.72 ms` | ` 26.14 ms` |

| • parse · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 20.65 µs/iter` | ` 19.94 µs` | ` 20.68 µs` | ` 21.78 µs` | ` 21.86 µs` |

| • parse · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  2.43 ms/iter` | `  2.25 ms` | `  2.43 ms` | `  3.39 ms` | `  3.50 ms` |

| • parse · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 26.29 ms/iter` | ` 23.06 ms` | ` 25.86 ms` | ` 36.98 ms` | ` 38.36 ms` |

| • parse · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  1.42 ms/iter` | `  1.20 ms` | `  1.47 ms` | `  2.31 ms` | `  2.41 ms` |

| • parse · yaml-rich-small |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 31.09 µs/iter` | ` 30.08 µs` | ` 31.07 µs` | ` 31.93 µs` | ` 33.24 µs` |

| • parse · yaml-rich-medium |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  2.64 ms/iter` | `  2.14 ms` | `  2.46 ms` | `  4.44 ms` | `  4.95 ms` |

| • parse · yaml-rich-large |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 22.60 ms/iter` | ` 20.99 ms` | ` 23.70 ms` | ` 24.47 ms` | ` 24.57 ms` |

### Speed — stringify (mitata, sequential)

| • stringify · small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  4.54 µs/iter` | `  4.42 µs` | `  4.57 µs` | `  4.89 µs` | `  4.96 µs` |
| lightning-yaml | ` 24.42 µs/iter` | ` 24.10 µs` | ` 24.66 µs` | ` 24.90 µs` | ` 25.08 µs` |

| • stringify · medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `511.41 µs/iter` | `459.02 µs` | `515.43 µs` | `873.44 µs` | `  1.08 ms` |
| lightning-yaml | `  4.43 ms/iter` | `  3.96 ms` | `  4.35 ms` | `  7.01 ms` | `  7.04 ms` |

| • stringify · large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  7.72 ms/iter` | `  7.04 ms` | `  7.55 ms` | ` 11.56 ms` | ` 12.42 ms` |
| lightning-yaml | ` 75.26 ms/iter` | ` 66.01 ms` | ` 77.86 ms` | ` 78.48 ms` | ` 80.52 ms` |

| • stringify · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 67.14 ms/iter` | ` 65.89 ms` | ` 68.40 ms` | ` 68.99 ms` | ` 69.11 ms` |
| lightning-yaml | `823.72 ms/iter` | `619.40 ms` | `806.73 ms` | `936.34 ms` | `   1.93 s` |

| • stringify · medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  1.01 ms/iter` | `886.67 µs` | `  1.03 ms` | `  1.46 ms` | `  4.46 ms` |
| lightning-yaml | `  6.21 ms/iter` | `  5.54 ms` | `  6.28 ms` | `  8.52 ms` | `  8.95 ms` |

| • stringify · large-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  8.44 ms/iter` | `  7.66 ms` | `  8.71 ms` | ` 10.11 ms` | ` 10.13 ms` |
| lightning-yaml | ` 64.11 ms/iter` | ` 57.43 ms` | ` 67.91 ms` | ` 69.27 ms` | ` 72.68 ms` |

| • stringify · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  3.98 µs/iter` | `  3.89 µs` | `  4.03 µs` | `  4.13 µs` | `  4.16 µs` |
| lightning-yaml | ` 21.63 µs/iter` | ` 21.29 µs` | ` 21.74 µs` | ` 21.83 µs` | ` 22.02 µs` |

| • stringify · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `531.20 µs/iter` | `431.72 µs` | `579.60 µs` | `731.08 µs` | `  1.20 ms` |
| lightning-yaml | `  4.04 ms/iter` | `  3.19 ms` | `  4.05 ms` | `  6.63 ms` | `  8.86 ms` |

| • stringify · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  5.66 ms/iter` | `  5.19 ms` | `  5.83 ms` | `  6.42 ms` | `  7.99 ms` |
| lightning-yaml | ` 49.95 ms/iter` | ` 48.18 ms` | ` 50.68 ms` | ` 50.96 ms` | ` 51.72 ms` |

| • stringify · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `211.96 µs/iter` | `188.97 µs` | `216.26 µs` | `348.99 µs` | `  1.01 ms` |
| lightning-yaml | `  1.18 ms/iter` | `  1.01 ms` | `  1.15 ms` | `  2.28 ms` | `  2.43 ms` |

| • stringify · yaml-rich-small |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 29.45 µs/iter` | ` 28.98 µs` | ` 29.59 µs` | ` 29.86 µs` | ` 30.39 µs` |

| • stringify · yaml-rich-medium |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  2.85 ms/iter` | `  2.53 ms` | `  2.83 ms` | `  4.00 ms` | `  4.34 ms` |

| • stringify · yaml-rich-large |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 39.67 ms/iter` | ` 38.04 ms` | ` 40.30 ms` | ` 40.78 ms` | ` 40.95 ms` |
...
| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.59 MB | 1.00x | -2.23 KB | 1.00x |
| lightning-yaml | 95.50 MB | 1.00x | 88.99 KB | -39.97x |

**stringify · small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.80 MB | 1.00x | -4.48 KB | 1.00x |
| lightning-yaml | 93.13 MB | 0.97x | 29.45 KB | -6.57x |

**parse · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 98.14 MB | 1.00x | 174.27 KB | 1.00x |
| lightning-yaml | 100.50 MB | 1.02x | 463.88 KB | 2.66x |

**stringify · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 92.95 MB | 1.00x | 97.51 KB | 1.00x |
| lightning-yaml | 106.80 MB | 1.15x | 209.48 KB | 2.15x |

**parse · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 125.16 MB | 1.00x | 1.95 MB | 1.00x |
| lightning-yaml | 135.37 MB | 1.08x | 3.27 MB | 1.68x |

**stringify · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 107.94 MB | 1.00x | 1.14 MB | 1.00x |
| lightning-yaml | 195.86 MB | 1.81x | 1.32 MB | 1.16x |

**parse · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 280.79 MB | 1.00x | 17.43 MB | 1.00x |
| lightning-yaml | 369.15 MB | 1.31x | 27.80 MB | 1.59x |

**stringify · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 300.56 MB | 1.00x | 10.23 MB | 1.00x |
| lightning-yaml | 635.91 MB | 2.12x | 9.98 MB | 0.98x |

**parse · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 94.23 MB | 1.00x | 229.27 KB | 1.00x |
| lightning-yaml | 100.34 MB | 1.06x | 417.51 KB | 1.82x |

**stringify · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 99.21 MB | 1.00x | 162.48 KB | 1.00x |
| lightning-yaml | 115.09 MB | 1.16x | 349.31 KB | 2.15x |

**parse · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 117.57 MB | 1.00x | 1.63 MB | 1.00x |
| lightning-yaml | 129.89 MB | 1.10x | 2.01 MB | 1.23x |

**stringify · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 110.99 MB | 1.00x | 1.19 MB | 1.00x |
| lightning-yaml | 187.89 MB | 1.69x | 1.91 MB | 1.61x |

**parse · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 89.91 MB | — | 108.40 KB | — |

**stringify · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.82 MB | 1.00x | -10.07 KB | 1.00x |
| lightning-yaml | 92.34 MB | 0.96x | 24.27 KB | -2.41x |

**parse · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 99.86 MB | — | 543.52 KB | — |

**stringify · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 115.48 MB | 1.00x | 89.77 KB | 1.00x |
| lightning-yaml | 138.43 MB | 1.20x | 185.59 KB | 2.07x |

**parse · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 137.57 MB | — | 2.80 MB | — |

**stringify · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 212.00 MB | 1.00x | 939.73 KB | 1.00x |
| lightning-yaml | 277.79 MB | 1.31x | 1.08 MB | 1.18x |

**parse · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 96.34 MB | — | 295.58 KB | — |

**stringify · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 108.90 MB | 1.00x | 29.80 KB | 1.00x |
| lightning-yaml | 108.39 MB | 1.00x | 153.88 KB | 5.16x |

**parse · yaml-rich-small**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 95.57 MB | — | 171.99 KB | — |

**stringify · yaml-rich-small**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 96.06 MB | — | 26.85 KB | — |

**parse · yaml-rich-medium**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 95.06 MB | — | 621.82 KB | — |

**stringify · yaml-rich-medium**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 116.48 MB | — | 214.59 KB | — |

**parse · yaml-rich-large**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 133.20 MB | — | 2.36 MB | — |

**stringify · yaml-rich-large**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 232.02 MB | — | 905.02 KB | — |
<!-- BENCH:OURS:END -->
