/**
 * js-yaml's memory-ratios entry. Each entry imports exactly one library — going
 * through bench/candidates.ts instead would pull every competitor's code into
 * this page's bundle and destroy the isolation the measurement depends on.
 */
