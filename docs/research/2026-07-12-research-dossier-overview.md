...
| doc | what it is |
| --- | --- |
| [2026-07-12-js-yaml-internals.md](2026-07-12-js-yaml-internals.md) | js-yaml 4.3.0 loader anatomy: why it's fast, and 12 enumerated inefficiencies to exploit (file:line cites) |
| [2026-07-12-eemeli-yaml-internals.md](2026-07-12-eemeli-yaml-internals.md) | `yaml` (eemeli) 2.9.0 pipeline anatomy: why it's 15–100× slower and where 2.6 GB of RSS goes |
| [2026-07-12-v8-json-parse-anatomy.md](2026-07-12-v8-json-parse-anatomy.md) | V8's actual `JSON.parse` source (C++, `src/json/`): 8 techniques, each with a JS-replicability verdict |
| [2026-07-12-wasm-route-evaluation.md](2026-07-12-wasm-route-evaluation.md) | WASM feasibility: native lib landscape, boundary costs (measured), packaging, linear-memory/RSS |
| [2026-07-12-pure-js-speed-ceiling.md](2026-07-12-pure-js-speed-ceiling.md) | How fast pure JS can go on V8: ceilings, string/scan/JIT/object-building evidence |
| [2026-07-12-local-microbenchmarks.md](2026-07-12-local-microbenchmarks.md) | Calibration on this machine incl. a 166-line pure-JS JSON parser at 57–76 % of native |
| [2026-07-12-design-a-pure-js-parser.md](2026-07-12-design-a-pure-js-parser.md) | **Design A — pure-JS single-pass parser (recommended)** |
| [2026-07-12-design-b-wasm-parser.md](2026-07-12-design-b-wasm-parser.md) | Design B — WASM-wrapped rapidyaml + in-wasm YAML→JSON transcode (rejected on the numbers) |
| [2026-07-12-design-c-hybrid-parser.md](2026-07-12-design-c-hybrid-parser.md) | Design C — Design A + `JSON.parse` delegation router + tiered fast paths |
| [2026-07-12-adversarial-verdicts.md](2026-07-12-adversarial-verdicts.md) | 12 adversarial verifications: 9 confirmed, 3 refuted |
| [2026-07-12-completeness-critique.md](2026-07-12-completeness-critique.md) | Ranked gaps: what none of the designs handled (stringify! N-API! block-mode spike! …) |
| [2026-07-12-v8-optimization-guide.md](2026-07-12-v8-optimization-guide.md) | User-supplied V8 coding guide (tier model, JIT rules, tier-residency CI recipe), reviewed and edited to defer to the dossier's measurements |
| [2026-07-12-adversarial-torture-tests.md](2026-07-12-adversarial-torture-tests.md) | **Correctness under hostile input** (2026-07-13 addition): parser-differential taxonomy, CVEs, and lightning-yaml's measured verdict per construct — incl. two intentional divergences. Locked by `test/adversarial.unit.ts` |
