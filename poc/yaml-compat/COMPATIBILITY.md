...
|---|---|---|---|---|
| `version` | PARTIAL | yaml-language-server | parser tests | '1.2' default; '1.1' enables merge-key resolution and y/n boolean resolution (verified vs `yaml` 2.9.0); other 1.1 tag-set differences not implemented |
