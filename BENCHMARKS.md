...
| • parse · small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  4.86 µs/iter` | `  4.70 µs` | `  4.83 µs` | `  5.33 µs` | `  5.81 µs` |
| lightning-yaml | ` 11.05 µs/iter` | ` 10.90 µs` | ` 11.09 µs` | ` 11.10 µs` | ` 11.24 µs` |

| • parse · medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `562.24 µs/iter` | `504.66 µs` | `567.81 µs` | `  1.01 ms` | `  1.21 ms` |
| lightning-yaml | `  1.09 ms/iter` | `  1.00 ms` | `  1.10 ms` | `  1.64 ms` | `  2.14 ms` |

| • parse · large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  6.78 ms/iter` | `  6.24 ms` | `  6.64 ms` | `  8.70 ms` | ` 10.41 ms` |
| lightning-yaml | ` 13.25 ms/iter` | ` 11.76 ms` | ` 13.95 ms` | ` 15.27 ms` | ` 15.31 ms` |

| • parse · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 73.16 ms/iter` | ` 67.40 ms` | ` 73.17 ms` | ` 75.26 ms` | ` 95.66 ms` |
| lightning-yaml | `141.55 ms/iter` | `125.08 ms` | `138.67 ms` | `145.26 ms` | `218.79 ms` |

| • parse · medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  1.15 ms/iter` | `  1.02 ms` | `  1.14 ms` | `  1.91 ms` | `  2.02 ms` |
| lightning-yaml | `  2.20 ms/iter` | `  1.94 ms` | `  2.20 ms` | `  3.28 ms` | `  3.58 ms` |

| • parse · large-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  8.16 ms/iter` | `  7.70 ms` | `  8.10 ms` | `  9.88 ms` | `  9.91 ms` |
| lightning-yaml | ` 15.79 ms/iter` | ` 14.41 ms` | ` 16.74 ms` | ` 17.87 ms` | ` 18.01 ms` |

| • parse · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 15.19 µs/iter` | ` 14.48 µs` | ` 15.44 µs` | ` 16.03 µs` | ` 16.33 µs` |

| • parse · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  1.73 ms/iter` | `  1.58 ms` | `  1.73 ms` | `  2.44 ms` | `  2.88 ms` |

| • parse · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 17.37 ms/iter` | ` 16.29 ms` | ` 17.80 ms` | ` 19.93 ms` | ` 20.43 ms` |

| • parse · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `985.89 µs/iter` | `866.33 µs` | `968.75 µs` | `  1.81 ms` | `  1.84 ms` |

| • parse · yaml-rich-small |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 23.88 µs/iter` | ` 22.42 µs` | ` 24.15 µs` | ` 24.39 µs` | ` 28.54 µs` |

| • parse · yaml-rich-medium |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  1.84 ms/iter` | `  1.66 ms` | `  1.89 ms` | `  2.58 ms` | `  2.96 ms` |

| • parse · yaml-rich-large |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 18.74 ms/iter` | ` 16.37 ms` | ` 19.12 ms` | ` 26.66 ms` | ` 26.82 ms` |

### Speed — stringify (mitata, sequential)

| • stringify · small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  3.16 µs/iter` | `  3.09 µs` | `  3.19 µs` | `  3.25 µs` | `  3.26 µs` |
| lightning-yaml | ` 12.73 µs/iter` | ` 12.49 µs` | ` 12.83 µs` | ` 12.90 µs` | ` 12.96 µs` |

| • stringify · medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `411.85 µs/iter` | `340.50 µs` | `405.30 µs` | `711.89 µs` | `  1.01 ms` |
| lightning-yaml | `  1.63 ms/iter` | `  1.42 ms` | `  1.66 ms` | `  2.58 ms` | `  2.68 ms` |

| • stringify · large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  4.99 ms/iter` | `  4.59 ms` | `  5.03 ms` | `  6.56 ms` | `  6.67 ms` |
| lightning-yaml | ` 22.25 ms/iter` | ` 20.85 ms` | ` 23.42 ms` | ` 24.28 ms` | ` 24.40 ms` |

| • stringify · xlarge-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | ` 46.53 ms/iter` | ` 44.41 ms` | ` 47.10 ms` | ` 49.11 ms` | ` 50.43 ms` |
| lightning-yaml | `368.73 ms/iter` | `328.30 ms` | `376.54 ms` | `453.73 ms` | `469.97 ms` |

| • stringify · medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `875.27 µs/iter` | `766.38 µs` | `864.32 µs` | `  1.24 ms` | `  4.21 ms` |
| lightning-yaml | `  2.91 ms/iter` | `  2.45 ms` | `  2.99 ms` | `  4.12 ms` | `  4.40 ms` |

| • stringify · large-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  6.35 ms/iter` | `  5.99 ms` | `  6.33 ms` | `  8.31 ms` | `  8.56 ms` |
| lightning-yaml | ` 27.15 ms/iter` | ` 23.22 ms` | ` 29.95 ms` | ` 32.85 ms` | ` 33.28 ms` |

| • stringify · yaml-plain-small-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  2.64 µs/iter` | `  2.53 µs` | `  2.66 µs` | `  2.82 µs` | `  2.91 µs` |
| lightning-yaml | ` 10.02 µs/iter` | `  9.89 µs` | ` 10.10 µs` | ` 10.14 µs` | ` 10.16 µs` |

| • stringify · yaml-plain-medium-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `357.18 µs/iter` | `322.32 µs` | `365.27 µs` | `549.43 µs` | `670.10 µs` |
| lightning-yaml | `  1.46 ms/iter` | `  1.32 ms` | `  1.46 ms` | `  2.22 ms` | `  2.44 ms` |

| • stringify · yaml-plain-large-records |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `  4.14 ms/iter` | `  3.89 ms` | `  4.13 ms` | `  5.65 ms` | `  5.99 ms` |
| lightning-yaml | ` 19.68 ms/iter` | ` 18.99 ms` | ` 19.87 ms` | ` 21.01 ms` | ` 22.66 ms` |

| • stringify · yaml-plain-medium-nested |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| JSON           | `174.16 µs/iter` | `158.48 µs` | `179.18 µs` | `254.39 µs` | `426.11 µs` |
| lightning-yaml | `620.26 µs/iter` | `542.51 µs` | `613.08 µs` | `  1.12 ms` | `  1.39 ms` |

| • stringify · yaml-rich-small |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 16.32 µs/iter` | ` 15.84 µs` | ` 16.54 µs` | ` 16.62 µs` | ` 17.76 µs` |

| • stringify · yaml-rich-medium |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | `  1.52 ms/iter` | `  1.36 ms` | `  1.49 ms` | `  2.37 ms` | `  2.42 ms` |

| • stringify · yaml-rich-large |              avg |         min |         p75 |         p99 |         max |
| -------------- | ---------------- | ----------- | ----------- | ----------- | ----------- |
| lightning-yaml | ` 17.16 ms/iter` | ` 16.63 ms` | ` 17.38 ms` | ` 17.84 ms` | ` 17.85 ms` |
...
| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 90.23 MB | 1.00x | -2.90 KB | 1.00x |
| lightning-yaml | 93.96 MB | 1.04x | 89.79 KB | -30.98x |

**stringify · small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 91.92 MB | 1.00x | -4.63 KB | 1.00x |
| lightning-yaml | 91.58 MB | 1.00x | 30.76 KB | -6.64x |

**parse · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 94.21 MB | 1.00x | 173.62 KB | 1.00x |
| lightning-yaml | 99.46 MB | 1.06x | 464.19 KB | 2.67x |

**stringify · medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 92.82 MB | 1.00x | 97.27 KB | 1.00x |
| lightning-yaml | 104.79 MB | 1.13x | 218.95 KB | 2.25x |

**parse · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 124.96 MB | 1.00x | 1.95 MB | 1.00x |
| lightning-yaml | 133.30 MB | 1.07x | 3.27 MB | 1.67x |

**stringify · large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 107.25 MB | 1.00x | 1.14 MB | 1.00x |
| lightning-yaml | 161.04 MB | 1.50x | 1.33 MB | 1.17x |

**parse · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 284.30 MB | 1.00x | 17.43 MB | 1.00x |
| lightning-yaml | 370.46 MB | 1.30x | 27.80 MB | 1.59x |

**stringify · xlarge-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 301.06 MB | 1.00x | 10.23 MB | 1.00x |
| lightning-yaml | 542.53 MB | 1.80x | 10.00 MB | 0.98x |

**parse · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.45 MB | 1.00x | 228.79 KB | 1.00x |
| lightning-yaml | 100.88 MB | 1.06x | 416.93 KB | 1.82x |

**stringify · medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 99.57 MB | 1.00x | 162.73 KB | 1.00x |
| lightning-yaml | 108.89 MB | 1.09x | 360.44 KB | 2.21x |

**parse · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 114.58 MB | 1.00x | 1.63 MB | 1.00x |
| lightning-yaml | 131.00 MB | 1.14x | 2.01 MB | 1.23x |

**stringify · large-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 110.48 MB | 1.00x | 1.19 MB | 1.00x |
| lightning-yaml | 178.62 MB | 1.62x | 1.91 MB | 1.61x |

**parse · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 95.62 MB | — | 109.13 KB | — |

**stringify · yaml-plain-small-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 95.96 MB | 1.00x | -10.73 KB | 1.00x |
| lightning-yaml | 92.17 MB | 0.96x | 24.97 KB | -2.33x |

**parse · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 98.48 MB | — | 548.31 KB | — |

**stringify · yaml-plain-medium-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 117.02 MB | 1.00x | 87.45 KB | 1.00x |
| lightning-yaml | 127.66 MB | 1.09x | 201.03 KB | 2.30x |

**parse · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 134.70 MB | — | 2.81 MB | — |

**stringify · yaml-plain-large-records**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 214.86 MB | 1.00x | 939.73 KB | 1.00x |
...
| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 95.35 MB | — | 322.88 KB | — |

**stringify · yaml-plain-medium-nested**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| JSON | 104.80 MB | 1.00x | 40.71 KB | 1.00x |
| lightning-yaml | 108.30 MB | 1.03x | 162.09 KB | 3.98x |

**parse · yaml-rich-small**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 93.40 MB | — | 173.39 KB | — |

**stringify · yaml-rich-small**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 95.82 MB | — | 28.71 KB | — |

**parse · yaml-rich-medium**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 93.70 MB | — | 637.04 KB | — |

**stringify · yaml-rich-medium**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 121.53 MB | — | 233.16 KB | — |

**parse · yaml-rich-large**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 130.18 MB | — | 2.34 MB | — |

**stringify · yaml-rich-large**

| candidate | peak RSS | vs JSON | heap Δ | vs JSON |
| --- | ---: | ---: | ---: | ---: |
| lightning-yaml | 208.16 MB | — | 922.68 KB | — |
<!-- BENCH:OURS:END -->
